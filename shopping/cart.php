              ...
              <div class="col-lg-8">
                <div class="p-5">
                  ...
                  <table class="table" height="190" >
                    ...
                    <button><?php foreach($allProducts as $products ): ?>
                      <tr class="mb-4">
                        <th scope="row"><?php echo $products->pro_id; ?></th>
                        <td><img width="100" height="100"
                        src="../images/<?php echo $products->pro_image; ?>"
                        class="img-fluid rounded-3" alt="Cotton T-shirt">
                        </td>
                        <td><?php echo $products->pro_name; ?></td>
                        <td>$<?php echo $products->pro_price; ?></td>
                        <td><input id="form1" min="1" name="quantity" value="<?php echo $products->pro_amount; ?>" type="number"
